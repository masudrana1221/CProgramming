...
int main()
{
   ...
   if (tourDays == 2 || tourDays == 4 || tourDays == 6)
   {
      if (tourDays == 2)
      {
         int raining;
      ...
      {
         int isChanderCarAvailable;
         printf(" If Chander Car is Available preach : 1 OR preach 0 : \n ");
         scanf("%d", &isChanderCarAvailable);
         if (isChanderCarAvailable == 1)
         {
            printf("No Boot Available\n");
            printf("Go Srimongol");
         }
